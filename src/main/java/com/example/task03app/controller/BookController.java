package com.example.task03app.controller;
...
import com.example.task03app.service.BookService;
...
public class BookController {
    ...
    @PostMapping("/save")
    public BookDto saveBookDto(@Valid @RequestBody BookDto bookDto) {
        log.info("Request save: {}", bookDto);
        BookDto bookDtoSaved = bookService.saveBookDto(bookDto);
        log.info("Response save: {}", bookDto);
        return bookDtoSaved;
    }
